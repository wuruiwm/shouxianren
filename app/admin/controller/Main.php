...
class Main extends Permissions
{
    public function index()
    {
         ...
         *网站信息
         */
        $web['user_num'] = Db::name('user')->count();
        $web['admin_cate'] = Db::name('admin_cate')->count();
        $web['ip_ban'] = Db::name('booking_order')->count();
        
        $web['article_num'] = Db::name('action')->count() + Db::name('news')->count();
        $web['status_article'] = Db::name('consumption_order')->count();
        $web['top_article'] = Db::name('article')->where('is_top',1)->count();
        $web['file_num'] = Db::name('square')->count();
        $web['status_file'] = Db::name('integral_log')->count();
        $web['ref_file'] = Db::name('attachment')->where('status',-1)->count();
        $web['message_num'] = Db::name('comment')->count();
        $web['look_message'] = Db::name('balance_log')->count();
